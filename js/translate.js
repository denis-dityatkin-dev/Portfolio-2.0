...
// 	// Arct
// 	setText('.projects__item:nth-child(1) .body-item-projects__link-title', t.arctTitle);
// 	setText('.projects__item:nth-child(1) .body-item-projects__text p', t.arctText);

// 	// Arik
// 	setText('.projects__item:nth-child(2) .body-item-projects__link-title', t.arikTitle);
// 	setText('.projects__item:nth-child(2) .body-item-projects__text p', t.arikText);

// 	// Gronberg
// 	setText('.projects__item:nth-child(3) .body-item-projects__link-title', t.gronbergTitle);
// 	setText('.projects__item:nth-child(3) .body-item-projects__text p', t.gronbergText);
...
// 	setText('.item-skill__item:nth-child(1) .item-skill__item-title', t.frontend);
// 	setText('.item-skill__item:nth-child(2) .item-skill__item-title', t.tools);
// 	setText('.item-skill__item:nth-child(3) .item-skill__item-title', t.currentlyLearning);
...
// 	setText('.contacts__subtitle', t.messageMe);
...
function setLanguage(lang) {
	...
	const projectsTitle =
		document.querySelector('.projects__title');
	...
	const skillsTitle =
		document.querySelector('.skills__title');
	...
	const aboutParagraphs =
		document.querySelectorAll('.about__text p');
	...
	// Заголовок страницы /projects
	const worksTitle =
		document.querySelector('.work .title-big');
	...
	// #complete-sites
	const completeSites =
		document.querySelector('.work .content-section__title');
